...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="bg-sage-400 shadow-sm">
        <div className="container mx-auto px-4 py-16 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-cream-50 tracking-tight">Welcome to RetroDraft</h1>
          <p className="text-xl text-cream-50 mb-8">Discover unique vintage-style prints</p>
        </div>
      </div>
